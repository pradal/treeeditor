...
VPlants.TreeEditor documentation
#########################################################################
...
- A `PDF <../latex/treeeditor.pdf>`_ version of |treeeditor| documentation is 
  available.

.. seealso::

   More documentation can be found on the
   `openalea <http://openalea.gforge.inria.fr/dokuwiki/doku.php?id=packages:vplants:treeeditor:treeeditor>`__ wiki.
